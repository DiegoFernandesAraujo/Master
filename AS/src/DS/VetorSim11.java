 ...
 * @author Diego
 */
public class VetorSim11 extends DedupAlg {

    File vetorSimilaridade = new File("./src/csv/conjuntosDS/vetorSimilaridades", "vetorSimilaridades-13-03.csv");
    FileWriter escreveArqVetor;
    BufferedWriter bwArqVetor = null;
    String a, b, c, d, e, rotulo;

    public VetorSim11(String baseDados1, String chavePrimaria, String gold, String goldId1, String goldId2, String result) {
    ...
    public void geraVetor(File arqDiverg) throws IOException {
        ...
        Soundex teste = new Soundex();
        System.out.println(teste.getSimilarity("Diego", "Demetrio"));
...
//                        System.out.println(pair.getFirstElement().getAttributeValues("title"));
//                        System.out.println(pair.getSecondElement().getAttributeValues("title"));

                        String a = pair.getFirstElement().getAttributeValues("title").toString();
                        String b = pair.getSecondElement().getAttributeValues("title").toString();
                        
                        System.out.println(teste.getSimilarity(a,b));
                        
//                        System.out.println(pair.getFirstElement().getAttributeValue("title").);
                        
                        
//                        System.out.println(teste.getSimilarity(pair.getFirstElement().getAttributeValue("title"), pair.getSecondElement().getAttributeValue("title")));
