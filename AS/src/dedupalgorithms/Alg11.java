...
public class Alg11 extends DedupAlg {
    ...
    public Alg11(String baseDados1, String chavePrimaria, String gold, String goldId1, String goldId2, String result, int ordem) {
...
//    File resultado = new File("./src/csv/datasets", "resultado.csv");
    ...
    public void executaDedupAlg() throws IOException {
        ...
        SoundExFunction similarityFunc3 = new SoundExFunction("artist");
...
//        statisticOutput = new SimpleStatisticOutput(System.out, statistic);
        ...
        for (DuDeObjectPair pair : algorithm) {
            ...
            if ((similarity >= 0.8) && (similarity2 >= 0.6)) {
                fechoTrans.add(pair);
    ...
    public static void main(String[] args) {
        Alg11 obj1 = new Alg11("cd", "pk", "cd_gold", "disc1_id", "disc2_id", "cd_result", 11);
        try {
