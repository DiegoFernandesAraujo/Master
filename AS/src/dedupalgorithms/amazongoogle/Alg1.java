...
//    File resultado = new File("./src/csv/datasets", "resultado.csv");
    ...
    public void executaDedupAlg() throws IOException {
        ...
        EuclideanDistanceFunction similarityFunc3 = new EuclideanDistanceFunction("description");
        NeedlemanWunschFunction similarityFunc4 = new NeedlemanWunschFunction("manufacturer");
        NeedlemanWunschFunction similarityFunc5 = new NeedlemanWunschFunction("price");
...
//            final double similarity = similarityFunc.getSimilarity(pair);
            ...
            //if (similarity >= 0.85 && similarity2 >= 0.75 && similarity3 >= 0.75 && similarity4 >= 0.75) { //Baseado no Alg17
...
//        Alg1 obj1 = new Alg1("DBLP2", "ACM", "num", "id", "DBLP2-ACM_perfectMapping_NEW", "idDBLP", "idACM", 1);
        ...
        Alg1 obj1 = new Alg1("Amazon", "GoogleProducts", "id", "id", "Amazon_GoogleProducts_perfectMapping", "idAmazon", "idGoogleBase", 1);
