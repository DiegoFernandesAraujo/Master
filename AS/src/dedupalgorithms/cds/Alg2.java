...
public class Alg2 extends DedupAlg {
    ...
    public Alg2(String baseDados1, String chavePrimaria, String gold, String goldId1, String goldId2, String result, int ordem) {
...
//        statisticOutput = new SimpleStatisticOutput(System.out, statistic);
    ...
    public static void main(String[] args) {
        Alg2 obj1 = new Alg2("cd", "pk", "cd_gold", "disc1_id", "disc2_id", "cd_result", 29);
        try {
