...
//        statisticOutput = new SimpleStatisticOutput(System.out, statistic);
        ...
        for (DuDeObjectPair pair : algorithm) {
            ...
            if ((similarity + similarity2 + similarity3 + similarity4 + similarity5 + similarity6) / 6.4 >= 0.95) {
                fechoTrans.add(pair);
        ...
        for (DuDeObjectPair pair : fechoTrans) {
            ...
            try {
                ...
                final double simNorm = (a + b + c + d + e + f) / 6.4;
...
//                bwSim.append(';');
    ...
    public static void main(String[] args) {
        Alg27 obj1 = new Alg27("cd", "pk", "cd_gold", "disc1_id", "disc2_id", 27);
        try {
