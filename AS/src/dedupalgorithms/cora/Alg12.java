...
public class Alg12 extends DedupAlg {
    ...
    public void executaDedupAlg() throws IOException {
        ...
        MongeElkanFunction similarityFunc = new MongeElkanFunction("author");
...
//                }
            ...
            if ((similarity >= 1) && (similarity2 >= 1) && (similarity3 >= 0.7)) {
                fechoTrans.add(pair);
            } else {
...
//                f = similarityFunc2.getSimilarity(pair);
    ...
    public static void main(String[] args) {
        Alg12 obj1 = new Alg12("CORA", "id", "cora_gold", "id1", "id2", 12);
        try {
