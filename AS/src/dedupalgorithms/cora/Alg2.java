 ...
 * @author Diego
 */
public class Alg2 extends DedupAlg {
    ...
    public Alg2(String baseDados1, String chavePrimaria, String gold, String goldId1, String goldId2, int ordem) {
        ...
        try {
            ...
            Logger.getLogger(Alg2.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
...
//                }
            ...
            if ((similarity >= 0.8) && (similarity2 >= 0.9) && (similarity3 >= 0.8)) {
                fechoTrans.add(pair);
            } else {
...
//                f = similarityFunc2.getSimilarity(pair);
    ...
    public static void main(String[] args) {
        Alg2 obj1 = new Alg2("CORA", "id", "cora_gold", "id1", "id2", 2);
        try {
