 ...
 * @author Diego
 */
public class Alg26 extends DedupAlg {
    ...
    public Alg26(String baseDados1, String chavePrimaria, String gold, String goldId1, String goldId2, int ordem) {
        ...
        try {
            ...
            Logger.getLogger(Alg26.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
...
//                }
            ...
            if ((similarity >= 0.7) && (similarity2 >= 0.85) && (similarity4 >= 0.3) && (similarity5 >= 0.2)) {
                fechoTrans.add(pair);
            } else {
...
//                f = similarityFunc2.getSimilarity(pair);
    ...
    public static void main(String[] args) {
        Alg26 obj1 = new Alg26("CORA", "id", "cora_gold", "id1", "id2", 26);
        try {
