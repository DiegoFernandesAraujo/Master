 ...
 * @author Diego
 */
public class Alg27 extends DedupAlg {
    ...
    public Alg27(String baseDados1, String chavePrimaria, String gold, String goldId1, String goldId2, int ordem) {
        ...
        try {
            ...
            Logger.getLogger(Alg27.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
...
//                }
            ...
            if ((similarity >= 0.9) && (similarity2 >= 0.6) && (similarity4 >= 0.6) && (similarity5 >= 0.2)) {
                fechoTrans.add(pair);
            } else {
...
//                f = similarityFunc2.getSimilarity(pair);
    ...
    public static void main(String[] args) {
        Alg27 obj1 = new Alg27("CORA", "id", "cora_gold", "id1", "id2", 27);
        try {
