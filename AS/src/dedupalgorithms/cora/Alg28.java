 ...
 * @author Diego
 */
public class Alg28 extends DedupAlg {
    ...
    public Alg28(String baseDados1, String chavePrimaria, String gold, String goldId1, String goldId2, int ordem) {
        ...
        try {
            ...
            Logger.getLogger(Alg28.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
...
//                }
            ...
            if ((similarity >= 0.9) && (similarity2 >= 0.6) && (similarity4 >= 0.2) && (similarity5 >= 0.2)) {
                fechoTrans.add(pair);
            } else {
...
//                f = similarityFunc2.getSimilarity(pair);
    ...
    public static void main(String[] args) {
        Alg28 obj1 = new Alg28("CORA", "id", "cora_gold", "id1", "id2", 28);
        try {
