 ...
 * @author Diego
 */
public class Alg29 extends DedupAlg {
    ...
    public Alg29(String baseDados1, String chavePrimaria, String gold, String goldId1, String goldId2, int ordem) {
        ...
        try {
            ...
            Logger.getLogger(Alg29.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
...
//                }
            ...
            if ((similarity >= 0.7) && (similarity2 >= 0.7) && (similarity5 >= 0.2)) {
                fechoTrans.add(pair);
            } else {
...
//                f = similarityFunc2.getSimilarity(pair);
    ...
    public static void main(String[] args) {
        Alg29 obj1 = new Alg29("CORA", "id", "cora_gold", "id1", "id2", 29);
        try {
