 ...
 * @author Diego
 */
public class Alg30 extends DedupAlg {
    ...
    public Alg30(String baseDados1, String chavePrimaria, String gold, String goldId1, String goldId2, int ordem) {
        ...
        try {
            ...
            Logger.getLogger(Alg30.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
...
//                }
            ...
            if ((similarity >= 0.85) && (similarity2 >= 0.85) && (similarity4 >= 0.3) && (similarity5 >= 0.2)) {
                fechoTrans.add(pair);
            } else {
...
//                f = similarityFunc2.getSimilarity(pair);
    ...
    public static void main(String[] args) {
        Alg30 obj1 = new Alg30("CORA", "id", "cora_gold", "id1", "id2", 30);
        try {
