 ...
 * @author Diego
 */
public class Alg32 extends DedupAlg {
    ...
    public Alg32(String baseDados1, String chavePrimaria, String gold, String goldId1, String goldId2, int ordem) {
        ...
        try {
            ...
            Logger.getLogger(Alg32.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
    ...
    public void executaDedupAlg() throws IOException {
        ...
        EuclideanDistanceFunction similarityFunc = new EuclideanDistanceFunction("author");
        EuclideanDistanceFunction similarityFunc2 = new EuclideanDistanceFunction("title");
        EuclideanDistanceFunction similarityFunc3 = new EuclideanDistanceFunction("journal");
        EuclideanDistanceFunction similarityFunc4 = new EuclideanDistanceFunction("volume");
        EuclideanDistanceFunction similarityFunc5 = new EuclideanDistanceFunction("pages");
        EuclideanDistanceFunction similarityFunc6 = new EuclideanDistanceFunction("date");
...
//                }
            ...
            if ((similarity >= 0.85) && (similarity2 >= 0.85) && (similarity5 >= 0.2)) {
                fechoTrans.add(pair);
            } else {
...
//                f = similarityFunc2.getSimilarity(pair);
    ...
    public static void main(String[] args) {
        Alg32 obj1 = new Alg32("CORA", "id", "cora_gold", "id1", "id2", 32);
        try {
