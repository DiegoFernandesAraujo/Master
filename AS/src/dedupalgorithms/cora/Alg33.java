 ...
 * @author Diego
 */
public class Alg33 extends DedupAlg {
    ...
    public Alg33(String baseDados1, String chavePrimaria, String gold, String goldId1, String goldId2, int ordem) {
        ...
        try {
            ...
            Logger.getLogger(Alg33.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
...
//                f = similarityFunc2.getSimilarity(pair);
    ...
    public static void main(String[] args) {
        Alg33 obj1 = new Alg33("CORA", "id", "cora_gold", "id1", "id2", 33);
        try {
