 ...
 * @author Diego
 */
public class Alg34 extends DedupAlg {
    ...
    public Alg34(String baseDados1, String chavePrimaria, String gold, String goldId1, String goldId2, int ordem) {
        ...
        try {
            ...
            Logger.getLogger(Alg34.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
    ...
    public void executaDedupAlg() throws IOException {
        ...
        LevenshteinDistanceFunction similarityFunc = new LevenshteinDistanceFunction("author");
...
//        similarityFunc2.setCompareArrayArrayStrategy(new AverageArrayArrayStrategy());
//        similarityFunc2.setCompareArrayAtomicStrategy(new ArrayConversionStrategy());
        LevenshteinDistanceFunction similarityFunc3 = new LevenshteinDistanceFunction("journal");
//        similarityFunc3.setCompareArrayArrayStrategy(new AverageArrayArrayStrategy());
//        similarityFunc3.setCompareArrayAtomicStrategy(new ArrayConversionStrategy());
        LevenshteinDistanceFunction similarityFunc4 = new LevenshteinDistanceFunction("volume");
//        similarityFunc4.setCompareArrayArrayStrategy(new AverageArrayArrayStrategy());
//        similarityFunc4.setCompareArrayAtomicStrategy(new ArrayConversionStrategy());
        LevenshteinDistanceFunction similarityFunc5 = new LevenshteinDistanceFunction("pages");
//        similarityFunc5.setCompareArrayArrayStrategy(new AverageArrayArrayStrategy());
//        similarityFunc5.setCompareArrayAtomicStrategy(new ArrayConversionStrategy());
        LevenshteinDistanceFunction similarityFunc6 = new LevenshteinDistanceFunction("date");
//        similarityFunc6.setCompareArrayArrayStrategy(new AverageArrayArrayStrategy());
//        similarityFunc6.setCompareArrayAtomicStrategy(new ArrayConversionStrategy());
...
//                f = similarityFunc2.getSimilarity(pair);
    ...
    public static void main(String[] args) {
        Alg34 obj1 = new Alg34("CORA", "id", "cora_gold", "id1", "id2", 34);
        try {
