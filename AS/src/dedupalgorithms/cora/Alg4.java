...
public class Alg4 extends DedupAlg {
    ...
    public Alg4(String baseDados1, String chavePrimaria, String gold, String goldId1, String goldId2, int ordem) {
...
//                }
            ...
            if ((similarity >= 0.7) && (similarity2 >= 0.7) && (similarity3 >= 0.9)) {
                fechoTrans.add(pair);
            } else {
...
//                f = similarityFunc2.getSimilarity(pair);
    ...
    public static void main(String[] args) {
        Alg4 obj1 = new Alg4("CORA", "id", "cora_gold", "id1", "id2", 4);
        try {
