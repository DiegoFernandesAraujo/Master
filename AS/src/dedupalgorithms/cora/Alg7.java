 ...
 * @author Diego
 */
public class Alg7 extends DedupAlg {
    ...
    public Alg7(String baseDados1, String chavePrimaria, String gold, String goldId1, String goldId2, int ordem) {
        ...
        try {
            ...
            Logger.getLogger(Alg7.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
...
//                }
            ...
            if ((similarity >= 0.4) && (similarity2 >= 0.6) && (similarity3 >= 0.8)) {
                fechoTrans.add(pair);
            } else {
...
//                f = similarityFunc2.getSimilarity(pair);
    ...
    public static void main(String[] args) {
        Alg7 obj1 = new Alg7("CORA", "id", "cora_gold", "id1", "id2", 7);
        try {
