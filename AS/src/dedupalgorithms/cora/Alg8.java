 ...
 * @author Diego
 */
public class Alg8 extends DedupAlg {
    ...
    public Alg8(String baseDados1, String chavePrimaria, String gold, String goldId1, String goldId2, int ordem) {
...
//                }
            ...
            if ((similarity >= 0.3) && (similarity2 >= 0.6) && (similarity3 >= 0.8)) {
                fechoTrans.add(pair);
            } else {
...
//                f = similarityFunc2.getSimilarity(pair);
    ...
    public static void main(String[] args) {
        Alg8 obj1 = new Alg8("CORA", "id", "cora_gold", "id1", "id2", 8);
        try {
