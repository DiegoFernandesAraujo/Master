...
public class Alg13 extends DedupAlg {
    ...
    public Alg13(String baseDados1, String baseDados2, String chavePrimaria1, String chavePrimaria2, String gold, String goldId1, String goldId2, int ordem) {
...
//    File resultado = new File("./src/csv/datasets", "resultado.csv");
    ...
    public void executaDedupAlg() throws IOException {
        ...
        for (DuDeObjectPair pair : algorithm) {
            ...
            if ((similarity >= 0.8) && (similarity2 >= 0.65) && (similarity3 >= 0.65)) {
...
//        Alg1 obj1 = new Alg1("DBLP2", "ACM", "num", "id", "DBLP2-ACM_perfectMapping_NEW", "idDBLP", "idACM", 1);
        ...
        Alg13 obj1 = new Alg13("DBLP2", "ACM", "id", "id", "DBLP2-ACM_perfectMapping", "idDBLP", "idACM", 13);
