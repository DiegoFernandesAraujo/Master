...
public class Alg2 extends DedupAlg {
    ...
    public Alg2(String baseDados1, String baseDados2, String chavePrimaria1, String chavePrimaria2, String gold, String goldId1, String goldId2, int ordem) {
...
//    File resultado = new File("./src/csv/datasets", "resultado.csv");
    ...
    public void executaDedupAlg() throws IOException {
        ...
        for (DuDeObjectPair pair : algorithm) {
            ...
            if ((similarity >= 0.75) && (similarity2 >= 0.75)) {
...
//
    ...
    public static void main(String[] args) {
        ...
        Alg2 obj1 = new Alg2("DBLP2", "ACM", "id", "id", "DBLP2-ACM_perfectMapping", "idDBLP", "idACM", 2);
