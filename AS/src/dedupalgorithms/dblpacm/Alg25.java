 ...
 * @author Diego
 */
public class Alg25 extends DedupAlg {
    ...
    public Alg25(String baseDados1, String baseDados2, String chavePrimaria1, String chavePrimaria2, String gold, String goldId1, String goldId2, int ordem) {
        ...
        try {
            ...
            Logger.getLogger(Alg25.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
...
//    File resultado = new File("./src/csv/datasets", "resultado.csv");
    ...
    public void executaDedupAlg() throws IOException {
        ...
        for (DuDeObjectPair pair : algorithm) {
            ...
            //Baseado no Alg20
            if (((similarity >= 0.9) || (similarity2 >= 0.9)) && ((similarity3 >= 0.8) || (similarity4 >= 0.8))) {
...
//        Alg1 obj1 = new Alg1("DBLP2", "ACM", "num", "id", "DBLP2-ACM_perfectMapping_NEW", "idDBLP", "idACM", 1);
        ...
        Alg25 obj1 = new Alg25("DBLP2", "ACM", "id", "id", "DBLP2-ACM_perfectMapping", "idDBLP", "idACM", 25);
