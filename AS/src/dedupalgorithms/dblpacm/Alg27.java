...
public class Alg27 extends DedupAlg {
    ...
    public Alg27(String baseDados1, String baseDados2, String chavePrimaria1, String chavePrimaria2, String gold, String goldId1, String goldId2, int ordem) {
...
//    File resultado = new File("./src/csv/datasets", "resultado.csv");
    ...
    public void executaDedupAlg() throws IOException {
        ...
        EuclideanDistanceFunction similarityFunc3 = new EuclideanDistanceFunction("title");
        ...
        for (DuDeObjectPair pair : algorithm) {
            ...
            //Baseado em Alg6
            if ((similarity >= 0.8) && (similarity2 >= 0.75)) {
...
//
    ...
    public static void main(String[] args) {
        ...
        Alg27 obj1 = new Alg27("DBLP2", "ACM", "id", "id", "DBLP2-ACM_perfectMapping", "idDBLP", "idACM", 27);
