...
public class Alg28 extends DedupAlg {
    ...
    public Alg28(String baseDados1, String baseDados2, String chavePrimaria1, String chavePrimaria2, String gold, String goldId1, String goldId2, int ordem) {
...
//        max.add(similarityFunc2);
        ...
        for (DuDeObjectPair pair : algorithm) {
            ...
            //Baseado em Alg16
            if ((similarity + similarity2)/2 >= 0.85 && similarity3 > 0.6) {
...
//        Alg1 obj1 = new Alg1("DBLP2", "ACM", "num", "id", "DBLP2-ACM_perfectMapping_NEW", "idDBLP", "idACM", 1);
        ...
        Alg28 obj1 = new Alg28("DBLP2", "ACM", "id", "id", "DBLP2-ACM_perfectMapping", "idDBLP", "idACM", 28);
