...
public class Alg29 extends DedupAlg {
    ...
    public Alg29(String baseDados1, String baseDados2, String chavePrimaria1, String chavePrimaria2, String gold, String goldId1, String goldId2, int ordem) {
...
//        max.add(similarityFunc2);
        ...
        for (DuDeObjectPair pair : algorithm) {
            ...
            //Baseado em Alg28
            if ((similarity + similarity2)/2 >= 0.75 && similarity3 > 0.55) {
...
//        Alg1 obj1 = new Alg1("DBLP2", "ACM", "num", "id", "DBLP2-ACM_perfectMapping_NEW", "idDBLP", "idACM", 1);
        ...
        Alg29 obj1 = new Alg29("DBLP2", "ACM", "id", "id", "DBLP2-ACM_perfectMapping", "idDBLP", "idACM", 29);
