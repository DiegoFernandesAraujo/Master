...
public class Alg32 extends DedupAlg {
    ...
    public Alg32(String baseDados1, String baseDados2, String chavePrimaria1, String chavePrimaria2, String gold, String goldId1, String goldId2, int ordem) {
...
//    File resultado = new File("./src/csv/datasets", "resultado.csv");
    ...
    public void executaDedupAlg() throws IOException {
        ...
        for (DuDeObjectPair pair : algorithm) {
            ...
            //Baseado em Alg21
            if ((similarity >= 0.85) && (similarity3 >= 0.8)) { //Testar esse!
...
//        Alg1 obj1 = new Alg1("DBLP2", "ACM", "num", "id", "DBLP2-ACM_perfectMapping_NEW", "idDBLP", "idACM", 1);
        ...
        Alg32 obj1 = new Alg32("DBLP2", "ACM", "id", "id", "DBLP2-ACM_perfectMapping", "idDBLP", "idACM", 32);
