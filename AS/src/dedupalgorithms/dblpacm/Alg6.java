...
public class Alg6 extends DedupAlg {
    ...
    public Alg6(String baseDados1, String baseDados2, String chavePrimaria1, String chavePrimaria2, String gold, String goldId1, String goldId2, int ordem) {
...
//
    ...
    public static void main(String[] args) {
        ...
        Alg6 obj1 = new Alg6("DBLP2", "ACM", "id", "id", "DBLP2-ACM_perfectMapping", "idDBLP", "idACM", 6);
