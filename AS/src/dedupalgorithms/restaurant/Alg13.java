...
public class Alg13 extends DedupAlg {
    ...
    public Alg13(String baseDados1, String chavePrimaria, String gold, String goldId1, String goldId2, int ordem) {
...
//            if ((similarity >= 0.45) && (similarity2 >= 0.2) && (similarity3 >= 0.45) && (similarity4 >= 0.6) && (similarity5 >= 0.25)) {
            if ((similarity >= 0.45) && (similarity2 >= 0.2) && (similarity4 >= 0.6) && (similarity5 >= 0.1)) {
                fechoTrans.add(pair);
...
//                f = similarityFunc2.getSimilarity(pair);
    ...
    public static void main(String[] args) {
        Alg13 obj1 = new Alg13("restaurant", "id", "restaurant_gold", "id_1", "id_2", 13);
        try {
