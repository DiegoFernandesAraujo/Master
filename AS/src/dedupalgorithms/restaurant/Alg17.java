 ...
 * @author Diego
 */
public class Alg17 extends DedupAlg {
    ...
    public Alg17(String baseDados1, String chavePrimaria, String gold, String goldId1, String goldId2, int ordem) {
        ...
        try {
            ...
            Logger.getLogger(Alg17.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
...
//            if ((similarity >= 0.75) && (similarity2 >= 0.5) && (similarity4 >= 0.8) && (similarity5 >= 0.2)) {
            if ((similarity >= 0.75) && (similarity4 >= 0.78)) {
                fechoTrans.add(pair);
...
//                f = similarityFunc2.getSimilarity(pair);
    ...
    public static void main(String[] args) {
        Alg17 obj1 = new Alg17("restaurant", "id", "restaurant_gold", "id_1", "id_2", 17);
        try {
