...
//            if ((similarity >= 0.75) && (similarity2 >= 0.5) && (similarity4 >= 0.8) && (similarity5 >= 0.2)) {
            if ((similarity >= 0.75) && (similarity2 >= 0.2) && (similarity4 >= 0.8) && (similarity5 >= 0.3)) {
                fechoTrans.add(pair);
...
//                f = similarityFunc2.getSimilarity(pair);
                ...
                final double simNorm = (a + b + d + e) / 4;
    ...
    public static void main(String[] args) {
        Alg2 obj1 = new Alg2("restaurant", "id", "restaurant_gold", "id_1", "id_2", 2);
        try {
