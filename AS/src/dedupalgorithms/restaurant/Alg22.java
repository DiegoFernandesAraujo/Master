...
public class Alg22 extends DedupAlg {
    ...
    public Alg22(String baseDados1, String chavePrimaria, String gold, String goldId1, String goldId2, int ordem) {
        ...
        try {
            ...
            Logger.getLogger(Alg22.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
...
//            if ((similarity >= 0.45) && (similarity2 >= 0.2) && (similarity3 >= 0.45) && (similarity4 >= 0.6) && (similarity5 >= 0.25)) {
            if ((similarity >= 0.8) && (similarity2 >= 0.7) && (similarity4 >= 0.8)) {
                fechoTrans.add(pair);
...
//                f = similarityFunc2.getSimilarity(pair);
    ...
    public static void main(String[] args) {
        Alg22 obj1 = new Alg22("restaurant", "id", "restaurant_gold", "id_1", "id_2", 22);
        try {
