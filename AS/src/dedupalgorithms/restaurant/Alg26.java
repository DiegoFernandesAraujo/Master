...
public class Alg26 extends DedupAlg {
    ...
    public void executaDedupAlg() throws IOException {
        ...
        JaroDistanceFunction similarityFunc4 = new JaroDistanceFunction("phone");
...
//            if ((similarity >= 0.45) && (similarity2 >= 0.2) && (similarity3 >= 0.45) && (similarity4 >= 0.6) && (similarity5 >= 0.25)) {
            if ((similarity >= 0.75) && (similarity2 >= 0.5) && (similarity4 >= 0.75)) {
                fechoTrans.add(pair);
...
//                f = similarityFunc2.getSimilarity(pair);
    ...
    public static void main(String[] args) {
        Alg26 obj1 = new Alg26("restaurant", "id", "restaurant_gold", "id_1", "id_2", 26);
        try {
