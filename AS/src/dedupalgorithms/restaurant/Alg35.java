 ...
 * @author Diego
 */
public class Alg35 extends DedupAlg {
    ...
    public Alg35(String baseDados1, String chavePrimaria, String gold, String goldId1, String goldId2, int ordem) {
        ...
        try {
            ...
            Logger.getLogger(Alg35.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
...
//                f = similarityFunc2.getSimilarity(pair);
    ...
    public static void main(String[] args) {
        Alg35 obj1 = new Alg35("restaurant", "id", "restaurant_gold", "id_1", "id_2", 35);
        try {
