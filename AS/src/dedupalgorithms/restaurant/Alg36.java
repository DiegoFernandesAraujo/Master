 ...
 * @author Diego
 */
public class Alg36 extends DedupAlg {
    ...
    public Alg36(String baseDados1, String chavePrimaria, String gold, String goldId1, String goldId2, int ordem) {
        ...
        try {
            ...
            Logger.getLogger(Alg36.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
...
//                f = similarityFunc2.getSimilarity(pair);
    ...
    public static void main(String[] args) {
        Alg36 obj1 = new Alg36("restaurant", "id", "restaurant_gold", "id_1", "id_2", 36);
        try {
