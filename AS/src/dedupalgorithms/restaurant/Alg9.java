...
public class Alg9 extends DedupAlg {
    ...
    public Alg9(String baseDados1, String chavePrimaria, String gold, String goldId1, String goldId2, int ordem) {
...
//            if ((similarity >= 0.5) && (similarity2 >= 0.45) && (similarity3 >= 0.45) && (similarity4 >= 0.6) && (similarity5 >= 0.45)) {
            if ((similarity >= 0.45) && (similarity2 >= 0.2) && (similarity3 >= 0.45) && (similarity4 >= 0.6) && (similarity5 >= 0.3)) {
                fechoTrans.add(pair);
...
//                f = similarityFunc2.getSimilarity(pair);
    ...
    public static void main(String[] args) {
        Alg9 obj1 = new Alg9("restaurant", "id", "restaurant_gold", "id_1", "id_2", 9);
        try {
