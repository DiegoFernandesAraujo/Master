 ...
 * implement your own {@link Database} adapter class). <code>DuDe</code> cannot offer this library due to licensing issues. In order to connect
 * <code>DuDe</code> with an Oracle database, you have to download the library and add it to your classpath manually. The driver can be found on the
