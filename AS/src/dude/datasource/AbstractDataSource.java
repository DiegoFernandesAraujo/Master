...
public abstract class AbstractDataSource<S extends AbstractDataSource<S>> extends AbstractCleanable implements DataSource {
	...
	/**
	 * <code>AbstractDataSourceIterator</code> can be used to generate valid {@link DuDeObject}s.
	 * 
	 * @author Matthias Pohl
	 * 
	 * @param <T>
	 ...
	 */
	protected abstract class AbstractDataSourceIterator<T extends AbstractDataSource<?>> extends AbstractIterator<DuDeObject> {
		...
		/**
		 * Generates a {@link DuDeObject} based on the data returned by {@link #loadNextRecord()}.
		 */
		@Override
		protected DuDeObject loadNextElement() throws ExtractionFailedException {
			...
			return new DuDeObject(currentObjectData, this.dataSource.getIdentifier(), objectId);
		}
	 ...
	 * 
	 * @param id
	 *            The identifier that is used within each generated {@link DuDeObject} as its source identifier.
	 */
