...
/**
 * {@link HouseNumberSimilarityFunction} compares two strings and treats them as ZIP codes, allowing for some special normalization and comparison techniques.
 * 
 * @author tobias.vogel
 */
public class HouseNumberSimilarityFunction extends ContentBasedSimilarityFunction<HouseNumberSimilarityFunction> {

	public HouseNumberSimilarityFunction(String... defaultAttribute) {
	...
	protected double compareAtomicValues(JsonAtomic value1, JsonAtomic value2) {
		String houseNumber1 = value1.getStringValue();
		String houseNumber2 = value2.getStringValue();

		houseNumber1 = normalize(houseNumber1);
		houseNumber2 = normalize(houseNumber2);
		...
		double typograhicalSimilarity = new JaroWinklerFunction((String[]) null).getSimilarity(houseNumber1, houseNumber2);
