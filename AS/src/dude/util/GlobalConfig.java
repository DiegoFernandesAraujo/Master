...
/**
 * <code>GlobalConfig</code> manages the configuration parameters of <code>DuDe</code>.
 * 
...
public class GlobalConfig {
	...
	/**
	 * Returns the maximum number of {@link DuDeObject} that will be stored in memory, if file-based processing is enabled.
	 * 
	...
	/**
	 * Sets the threshold for storing {@link DuDeObject}s in memory, if file-based processing is enabled.
	 * 
	 * @param value
	 *            The new threshold.
	 * 
	...
	public void saveConfig(OutputStream outputStream) throws IOException {
		...
		properties.store(outputStream, "DuDe configuration");
	}
