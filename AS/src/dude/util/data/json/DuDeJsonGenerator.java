...
/**
 * <code>DuDeJsonGenerator</code> is another implementation for generating Json code. It is used by {@link Jsonable#toJson(DuDeJsonGenerator)}. This
 * approach is faster than the old implementation {Jsonable#toJsonString(int)} but slower than {Jsonable#toJsonString()}.
 * 
 * @author Matthias Pohl
 */
public class DuDeJsonGenerator implements Closeable {
	...
	/**
	 * Initializes a new <code>DuDeJsonGenerator</code>.
	 * 
	 * @param outStream
	...
	public DuDeJsonGenerator(Writer writer) throws IOException {
		...
		this.generator = DuDeJsonGenerator.factory.createJsonGenerator(writer);
	}

	/**
	 * Initializes a new <code>DuDeJsonGenerator</code> with the given generator.
	 * 
	 * @param generator
	 ...
	 */
	protected DuDeJsonGenerator(JsonGenerator generator) {
		if (generator == null)
