...
public class CompositeJsonSerialization<T> extends AutoJsonSerialization<T> {
	...
	private static final Logger Log = Logger.getLogger(DuDeJsonParser.class.getPackage().getName());
	 ...
	 */
	@Override
	public T read(DuDeJsonParser<?> parser, Object currentValue) throws JsonParseException, IOException {
	...
	private void readComplexFields(DuDeJsonParser<?> parser, T instance) throws JsonParseException, IOException, EOFException, IllegalAccessException {
	 ...
	 * (non-Javadoc)
	 * 
	 * @see de.hpi.fgis.dude.util.data.json.auto.JsonTypeInfo#readFields(de.hpi.fgis.dude.util.data.json.DuDeJsonParser, I)
	 */
	@Override
	public void readFields(DuDeJsonParser<?> parser, T instance) throws JsonParseException, IOException, EOFException {
		try {
	...
	private T readJsonable(DuDeJsonParser<?> parser, final Class<T> declaredType) throws JsonParseException, IOException {
	...
	@SuppressWarnings("unchecked")
	private void readPrimitiveFields(DuDeJsonParser<?> parser, T instance) throws JsonParseException, IOException, IllegalAccessException {
	 ...
	 */
	@Override
	public void write(DuDeJsonGenerator generator, T jsonable) throws JsonGenerationException, IOException {
	 ...
	 * (non-Javadoc)
	 * 
	 * @see de.hpi.fgis.dude.util.data.json.auto.JsonTypeInfo#writeFields(de.hpi.fgis.dude.util.data.json.DuDeJsonGenerator, java.lang.Object)
	 */
	@Override
	...
	@SuppressWarnings("unchecked")
	private void writeComplexFields(DuDeJsonGenerator generator, Object jsonable) throws JsonGenerationException, IOException, IllegalAccessException {
		for (final Entry<Field, AutoJsonSerialization> entry : this.jsonableFields.entrySet()) {
			final Field field = entry.getKey();
	...
	@SuppressWarnings("unchecked")
	private void writePrimitiveFields(DuDeJsonGenerator generator, Object jsonable) throws JsonGenerationException, IOException,
