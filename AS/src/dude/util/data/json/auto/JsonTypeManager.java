...
public class JsonTypeManager {
	...
	private void initPrimitives() {
		final Primitive<Number> numberPrimitive = new Primitive<Number>(Number.class) {
			@Override
			Number read(DuDeJsonParser<?> parser) throws JsonParseException, IOException {
			...
			@Override
			public void write(Number object, DuDeJsonGenerator generator) throws JsonGenerationException, IOException {
				if (object == null)
		...
		final Primitive<Float> floatPrimitive = new Primitive<Float>(Float.class) {
			@Override
			Float read(DuDeJsonParser<?> parser) throws JsonParseException, IOException {
				if (parser.currentToken() == JsonToken.VALUE_NULL) {
					parser.nextJsonNull();
					return null;
				}
			...
			@Override
			void write(Float object, DuDeJsonGenerator generator) throws JsonGenerationException, IOException {
				if (object == null)
					generator.writeJsonNull();
				else
					generator.writeNumber(object);
		...
		this.addPrimitive(String.class, new Primitive<String>(String.class) {
			@Override
			String read(DuDeJsonParser<?> parser) throws JsonParseException, IOException {
				return parser.nextString();
			}

			@Override
			public void write(String object, DuDeJsonGenerator generator) throws JsonGenerationException, IOException {
		...
		this.addPrimitive(Locale.class, new Primitive<Locale>(Locale.class) {
			@Override
			Locale read(DuDeJsonParser<?> parser) throws JsonParseException, IOException {
				return new Locale(parser.nextString());
			}

			@Override
			void write(Locale object, DuDeJsonGenerator generator) throws JsonGenerationException, IOException {
		...
		final Primitive<Boolean> booleanPrimitive = new Primitive<Boolean>(Boolean.class) {
			@Override
			Boolean read(DuDeJsonParser<?> parser) throws JsonParseException, IOException {
				return parser.nextJsonBoolean().getValue();
			}

			@Override
			public void write(Boolean object, DuDeJsonGenerator generator) throws JsonGenerationException, IOException {
		...
		final Primitive<Character> charPrimitive = new Primitive<Character>(Character.class) {
			@Override
			Character read(DuDeJsonParser<?> parser) throws JsonParseException, IOException {
				return parser.nextString().charAt(0);
			}

			@Override
			public void write(Character object, DuDeJsonGenerator generator) throws JsonGenerationException, IOException {
				generator.writeString(object.toString());
			}
		};
