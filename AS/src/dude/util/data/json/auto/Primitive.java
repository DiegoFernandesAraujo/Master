...
public abstract class Primitive<T> {
	 ...
	 */
	abstract T read(DuDeJsonParser<?> parser) throws JsonParseException, IOException;
	 ...
	 *            the object to write
	 * @param generator
	 *            the {@link DuDeJsonGenerator} rendering the passed value to json
	 * 
	 ...
	 */
	abstract void write(T object, DuDeJsonGenerator generator) throws JsonGenerationException, IOException;
