 ...
 */
public class FileBasedStorage<T extends Jsonable> extends AbstractDuDeStorage<T> {
	...
	private class FileBasedReader implements JsonableReader<T> {
		...
		public Iterator<T> iterator() {
			try {
				...
				return new DuDeJsonParser<T>(FileBasedStorage.this.internalType, reader);
	...
	private class FileBasedWriter extends AbstractJsonableWriter<T> {
		...
		private DuDeJsonGenerator generator = new DuDeJsonGenerator(new BufferedWriter(new FileWriter(FileBasedStorage.this.file)));
