...
/**
 * Para gerar o gabarito do febrl
 * @author Diego
 */
public class GeradoraGabaritoFebrl {
    ...
    public void geraGab(File base) throws IOException {
        ...
        try {
            ...
            Logger.getLogger(GeradoraGabaritoFebrl.class.getName()).log(Level.SEVERE, null, ex);
        } catch (IOException ex) {
            Logger.getLogger(GeradoraGabaritoFebrl.class.getName()).log(Level.SEVERE, null, ex);
        } finally {
            brBase.close();
    ...
    public static void main(String[] args) throws IOException {
        GeradoraGabaritoFebrl obj = new GeradoraGabaritoFebrl();
