...
#             'freq_file':'data'+os.sep+'givenname.csv',
           'select_prob':0.10,
...
#           'freq_file':'data'+os.sep+'surname.csv',
         'select_prob':0.15,
...
#                'freq_file':'data'+os.sep+'streetnumber.csv',
              'select_prob':0.10,
                 'ins_prob':0.10,
                 'del_prob':0.15,
                 'sub_prob':0.60,
...
#            'freq_file':'data'+os.sep+'address1.csv',
          'select_prob':0.10,
             'ins_prob':0.10,
             'del_prob':0.15,
             'sub_prob':0.55,
...
#            'freq_file':'data'+os.sep+'address2.csv',
          'select_prob':0.10,
             'ins_prob':0.04,
             'del_prob':0.04,
             'sub_prob':0.10,
...
#          'freq_file':'data'+os.sep+'suburb.csv',
        'select_prob':0.10,
...
#            'freq_file':'data'+os.sep+'postcode.csv',
          'select_prob':0.05,
             'ins_prob':0.00,
             'del_prob':0.00,
             'sub_prob':0.35,
...
#         'freq_file':'data'+os.sep+'state.csv',
       'select_prob':0.05,
          'ins_prob':0.10,
          'del_prob':0.10,
          'sub_prob':0.55,
