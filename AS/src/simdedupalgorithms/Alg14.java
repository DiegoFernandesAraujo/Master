...
public class Alg14 extends DedupAlg {
    ...
    public Alg14(String baseDados1, String chavePrimaria, String gold, String goldId1, String goldId2, String result, int ordem) {
...
//        statisticOutput = new SimpleStatisticOutput(System.out, statistic);
        ...
        for (DuDeObjectPair pair : algorithm) {
            ...
            if ((similarity >= 0.8) && (similarity2 >= 0.85)) {
                fechoTrans.add(pair);
    ...
    public static void main(String[] args) {
        Alg14 obj1 = new Alg14("cd", "pk", "cd_gold", "disc1_id", "disc2_id", "cd_result", 14);
        try {
