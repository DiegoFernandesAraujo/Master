...
public class Alg22 extends DedupAlg {
    ...
    public Alg22(String baseDados1, String chavePrimaria, String gold, String goldId1, String goldId2, String result, int ordem) {
...
//        statisticOutput = new SimpleStatisticOutput(System.out, statistic);
        ...
        for (DuDeObjectPair pair : algorithm) {
            ...
            if ( (similarity + similarity2 + similarity3  + similarity4 )/4.8 >= 0.8) {
                fechoTrans.add(pair);
...
//                f = similarityFunc2.getSimilarity(pair)*0.9;
                ...
                final double simNorm = (a + b + c + d) / 4.8;
...
//                bwSim.append(';');
    ...
    public static void main(String[] args) {
        Alg22 obj1 = new Alg22("cd", "pk", "cd_gold", "disc1_id", "disc2_id", "cd_result", 22);
        try {
