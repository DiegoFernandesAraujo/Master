 ...
 * @author Diego
 */
public class Alg23 extends DedupAlg {
    ...
    public Alg23(String baseDados1, String chavePrimaria, String gold, String goldId1, String goldId2, String result, int ordem) {
...
//                bwSim.append(';');
    ...
    public static void main(String[] args) {
        Alg23 obj1 = new Alg23("cd", "pk", "cd_gold", "disc1_id", "disc2_id", "cd_result", 23);
        try {
            obj1.executaDedupAlg();
        } catch (IOException ex) {
            Logger.getLogger(Alg23.class.getName()).log(Level.SEVERE, null, ex);
        }
        java.awt.Toolkit.getDefaultToolkit().beep();
    }
