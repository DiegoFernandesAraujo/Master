...
public class Alg8 extends DedupAlg {
    ...
    public Alg8(String baseDados1, String chavePrimaria, String gold, String goldId1, String goldId2, String result, int ordem) {
...
//                bwSim.append(';');
    ...
    public static void main(String[] args) {
        Alg8 obj1 = new Alg8("cd", "pk", "cd_gold", "disc1_id", "disc2_id", "cd_result", 8);
        try {
